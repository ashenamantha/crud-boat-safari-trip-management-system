        ...
        <div class="sidenav">
            ...
            <ul>
                ...
                <li><i class="fa fa-users" aria-hidden="true"></i><a
                        href="?content=manageUser">&nbsp;Manage&nbsp;Users</a></li>
                <li><i class="fa fa-square" aria-hidden="true"></i><a
                        href="?content=managePackage">&nbsp;Manage&nbsp;Packages</a></li>
                <li><i class="fa fa-bookmark" aria-hidden="true"></i><a
                        href="?content=manageBooking">&nbsp;Check&nbsp;Reservations</a></li>
